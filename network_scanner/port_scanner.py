...
#Defines 4 possible modes: 1 scans the 1023 standarized ports
#2 scans 49152 reserved ports
#3 Scans the most common ports 
#4 Scan a custom set of ports
def get_ports(mode):
    if mode == 1:
